...
import com.training.todo_list.dao.MaBase;
...
public class TodoManager {
    ...
    public void update(String pSDescription,  UUID pIdTodoType,UUID pIdTodo, boolean pBIsDone) {

        Todo tTodo = todoFor(pIdTodo);
        tTodo.setmSDescription(pSDescription);
        tTodo.setmIdTodoType(pIdTodoType);
        tTodo.setmBIsDone(pBIsDone);
